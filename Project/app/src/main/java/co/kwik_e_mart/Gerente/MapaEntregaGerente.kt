...
class MapaEntregaGerente : AppCompatActivity() {
    ...
    private fun addMyLocationOverlay() {
        ...
        myLocationOverlay!!.runOnFirstFix {
            ...
            if (location != null) {
                ...
                runOnUiThread {
                    Toast.makeText(this@MapaEntregaGerente, "Unable to get current location", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
    private fun addMapLongClickListener() {
        val mapEventsOverlay = MapEventsOverlay(object : MapEventsReceiver {
            ...
            override fun longPressHelper(p: GeoPoint): Boolean {
                ...
                currentMarker!!.title = getAddressFromLatLng(this@MapaEntregaGerente, p)
                currentMarker!!.icon = ContextCompat.getDrawable(this@MapaEntregaGerente, android.R.drawable.star_big_on)
    ...
    private inner class GetRoadTask : AsyncTask<GeoPoint, Void, Road>() {
        override fun doInBackground(vararg params: GeoPoint): Road? {
            ...
            val roadManager = OSRMRoadManager(this@MapaEntregaGerente)
        ...
        override fun onPostExecute(result: Road?) {
            if (result != null) {
                if (result.mStatus == Road.STATUS_OK) {
                    ...
                    Toast.makeText(this@MapaEntregaGerente, "Error calculating road", Toast.LENGTH_SHORT).show()
                }
            } else {
                Toast.makeText(this@MapaEntregaGerente, "Failed to retrieve road data", Toast.LENGTH_SHORT).show()
            }
        }
    }
