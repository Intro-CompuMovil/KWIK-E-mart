...
class ProductAdapter(private val productList: List<Productos>,
    ...
    class ProductViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val nombreTextView: TextView = itemView.findViewById(R.id.courierNameTextView)
        val precioTextView: TextView = itemView.findViewById(R.id.calificacionTextView)
        val categoriaTextView: TextView = itemView.findViewById(R.id.preciopromedioTextView)
